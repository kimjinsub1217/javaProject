...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		//변수 : 프로그램이 시작되어 클래스들이 메모리에 올라갈 때 생성되는 변수이다.
		//객체 참조 변수를 통해서도 사용이 가능하며 딱 하나의 변수만 생성된다.
		//프로그램 전체에서 딱 하나만 존재하는 값을 저장할 때 사용하낟.
		//메서드 : static 변수나, 매개변수를 포함한 지역변수만 사용이 가능하다.
		//static 변수나 매개 변수를 포함한 지역변수만 사용하는 매서드의 경우 static 으로 정의하면 편하게 사용할 수 있다.
		...
		//객체 생성없이 멤버변수 사용
		//static이 아닌 멤버들은 객체를 생성해야지만 사용할 수 있기 때문에
		//static 처럼 클래스 이름으로 접근하는 것은 불가능하다.
