...
class TestClass1 {
	public void testMethod1() {
		System.out.println("테스트메서드 1");
	}

	public void testMethod2() {
		System.out.println("테스트메서드 2");
	}
	...
	// 호출한 쪽으로 되돌아 갈 때 값 하나를 절달할 수 있다.
	...
	// 매개변수가 있는 메서드는 메서드를 호출할 떄 반드시 매개변수에 저장될 값을
...
class TestClass2 {
	public void testMethod3() {
		System.out.println("테스트메서드 3");
	}

	public void testMethod4() {
		System.out.println("테스트메서드 4");
	}
