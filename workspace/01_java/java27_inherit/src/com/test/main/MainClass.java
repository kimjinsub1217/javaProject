...
public class MainClass {
	...
	public static void main(String[] args) {
        ...
        SubClass2 sub3 = new SubClass2(200);
...
//이 떄 생성자에서 부모 클래스의 생성자를 자동으로 해출해주면
...
class SubClass2 extends SuperClass2{
    ...
    //부모의 생성자 호출을 명시하지 않으면 부모의 생성자 중 매개 변수가 없는
    //기본 생성자가 호출된다.
    //만약 부모의 새성자를 선택하고 싶다면 super를 사용한다.
