...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// 시프트 연산자
		// >> 비트를 오론쪽으로 지정한 만큼 이동한다.
		// << 비트를 왼쪽으로 지정한 만큼 이동한다.
		// >>> 비트를 오른쪽으로 지정한 만큼 이동한다. 0으로 채운다.
		...
		// && and
		// 둘 다 true여야지만 결과가 true 둘 중 하나라도 false면
		// 결과는 false이다.
		...
		// || : 둘다 false 여야지만 false이고 둘 중 하나라도
		// true라면 결과는 true이다.
		...
		// 3항 연산자
		// 주어진 비교 연산의 결과가 true 면 값이 1이 연산의 결과가 되고
