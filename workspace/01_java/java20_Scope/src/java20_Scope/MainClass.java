package java20_Scope;

public class MainClass {

	public static void main(String[] args) {
		// 변수 , 메서드 등의 사용 범위
		// 변수나 메서드를 현재 사용 가능하지에 대한 이야기
		// 객체의 멤버 변수나 멤버 메서드는 객체가 생성되어야지만 사용이 가능하다.
		// 객체가 소멸되면 멤버 변수도 소멸되기 때문에 사용이 불가능하다.
		// 객체가 소멸되면 객체를 통해 메서드를호출하지 못하므로 사용이 불가능하다.
		// 자바는 기본적으로 블럭스코프를 가진다.
		// 블럭 스코프 : 변수 등이 선언된 블럭( { } ) 내부에서 사용이 가능하다.

		// 객체를 생성한다.
		// 객체를 생성하면 멤버 변수들도 생성되기 떄문에 멤버 변수를 사용할 수 있다.
...
class TestClass1 {
	...
	public void testMethod1() {
		...
		// 같은 객체에 있는 멤버 변수의 사용
		// 멤버 메서드는 객체를 생성하고 그 객체를 통해서 호출할 수 있기 때문에 멤버 변수가 생성되어 있다는 것을 보장
	...
	// 지역변수 예제
	// 메서드가 내부에 정의한 변수들을 의미한다.
	// 변수가 정의된 블럭이 끝나면 변수는 소멸된다.

	// 매개변수. 매개변수는 메서드의 지역변수에 해당한다.
	// 따라서 매개 변수가 정의된 메서드 내부에서만 사용이 가능하다.
	public void testMethod2(int a1, int a2) {
		...
		//제어문 내부
		for(int i =0;i<3;i++) {
			//제어문 내부에서 선언된 변수는 제어문 내부에서만 사용이 가능하고 제어문 수행이 끝나면 소멸된다.
			int a5 =300;
